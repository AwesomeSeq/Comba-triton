...
# from fla.ops.gated_delta_rule_pk import chunk_gated_delta_rule_pk
...
#         p = F.normalize(torch.randn(B, H, T, D, dtype=torch.float32), p=2, dim=-1).to(dtype)
...
#     ref, ref_ht = chunk_comba_dplr_ref(
#         q.clone(),
#         k.clone(),
#         v.clone(),
#         p.clone(),
...
#     ref, ref_ht = chunk_comba_iplr_ref(
#         q.clone(),
#         k.clone(),
#         v.clone(),
#         p.clone(),
